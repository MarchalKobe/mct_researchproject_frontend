...
<template>
    <nav class="c-navbar">
        <div class="u-flex u-direction-column u-align-center">
            ...
            <RouterLink class="c-navbar__element c-button__icon" :class="path === '/classes' ? 'c-button__icon-selected' : ''" to="/classes" data-information="Home">
        ...
        <div class="u-flex u-direction-column u-align-center">
            <button class="c-navbar__element c-button__icon c-button__icon-alpha u-margin-bottom-md" @click="logout" data-information="Log out">
            ...
            <div class="c-navbar__profile">
                <RouterLink class="c-navbar__element c-button__soft" to="/profile" data-information="Profile">
